...
func (d *Package) GenerateFiles(sourceDir string, pkgDir string) error {
	...
	log.Printf("base structure created: %s", debianDir)

	if err := os.MkdirAll(filepath.Join(dataDir), 0755); err != nil {
		return err
	}
	log.Printf("data dir created: %s", dataDir)
	...
	log.Println("files structure created")
	...
	log.Printf("init default file created\n")
	...
	log.Printf("conffiles file created\n")
	...
	log.Printf("control file created\n")
	...
	log.Printf("changelog file created\n")
	...
	log.Printf("copyright file created\n")
	...
	log.Printf("preinst file created\n")
	...
	log.Printf("postinst file created\n")
	...
	log.Printf("postrm file created\n")
	...
	log.Printf("man pages index file created\n")
...
func (d *Package) ImportFiles(sourceDir string) error {
	for _, fileInst := range d.Files {
		...
		log.Printf("fileInst.To=%q\n", fileInst.To)
		log.Printf("fileInst.Base=%q\n", fileInst.Base)
		log.Printf("fileInst.Fperm=%q\n", fileInst.Fperm)
		log.Printf("fileInst.fperm=%#o\n", fperm)
		log.Printf("fileInst.Dperm=%q\n", fileInst.Dperm)
		log.Printf("fileInst.dperm=%#o\n", dperm)
		if err != nil {
